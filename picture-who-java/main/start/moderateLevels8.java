...
public class moderateLevels8 implements ActionListener {
...
// Hint system variables and methods for providing hints to players
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("main\\img\\18.png");
        ...
        answerPanel.setBorder(BorderFactory.createEmptyBorder(20, 380, 10, 380));
    ...
    private void checkAnswers(JFrame gameFrame) {
        ...
        String correctAnswer3 = "z";
        String correctAnswer4 = "z";
        String correctAnswer5 = "a";
        ...
        if (enteredAnswer1.equals(correctAnswer1) &&
            ...
            timer.stop();
            String message = ("<html><div style='text-align: center; margin-left: 60px; margin-right: 60px;'><span style='font-family: Paytone One; font-size: 20px; color: #443C3C;'>PIZZA!</span><br><span style='font-size: 27px; color: #5E4580;'>Brilliant</span></div></html>");
