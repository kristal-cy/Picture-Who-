...
public class hardLevels3 implements ActionListener {
...
// Hint system variables and methods for providing hints to players
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("main\\img\\23.png");
    ...
    private void checkAnswers(JFrame gameFrame) {
        ...
        if (enteredAnswer1.equals(correctAnswer1) &&
            ...
            timer.stop();
            String message = ("<html><div style='text-align: center; margin-left: 60px; margin-right: 60px;'><span style='font-family: Paytone One; font-size: 20px; color: #443C3C;'>CROCODILE!</span><br><span style='font-size: 27px; color: #5E4580;'>Brilliant</span></div></html>");
    ...
    private void openNextLevel() {
        currentLevel++;
        new hardLevels4(); // Open the difficulty selection window
    }    
